        ...
        >
          ...
          >
            {childrenNodes.map((child, index) => {
              ...
              // Fix numeric precision differences between server and client
              // by rounding to a stable number of decimals.
              const xFixed = x.toFixed(3);
              const yFixed = y.toFixed(3);
              const rotFixed = (rotationAngle + 90).toFixed(3);
              ...
              return (
                <li
                  ...
                  style={{
                    ...
                    transform: `translate(-50%, -50%) translate3d(${xFixed}px, ${yFixed}px, 0) rotate(${rotFixed}deg)`,
                  }}
                >
                  {/* 
